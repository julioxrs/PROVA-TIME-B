...
public class HorarioDAO {
    ...
    public void inserir(Horario horario){
        ...
        try{
            ...
            stmt.setInt(4, horario.getUsuario().getId());
    ...
    public List<Horario> buscarDisponiveis(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                Usuario user = new Usuario(); // instancia novo objeto Usuario para salva id do mesmo
                user.setId(rs.getInt("id_usuario_agendamento"));
